    ...
    <div className="relative">
      ...
      {!disableLabel && showLabel && !error && (
        <motion.p
          ...
          className="absolute -top-[9px] left-2 z-10 bg-white px-px text-xs text-secondary dark:bg-dark"
        >
          {placeholder}
        </motion.p>
      )}
      ...
      {!disableLabel && error && (
        <motion.p
          ...
          initial={{ scale: 1.1 }} // Start below
          transition={{ duration: 0.2, ease: [0.4, 0, 0.2, 1] }}
          className="absolute -top-[9px] left-2 z-10 bg-white px-px text-xs text-[#e22743] dark:bg-dark"
        >
          {errorLabel}
        </motion.p>
      )}
