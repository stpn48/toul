...
import { AddSetModal } from "../CreateExerciseModal/AddSetModal";
import { CreateExerciseButton } from "../CreateExerciseModal/CreateExerciseButton";
import CreateExerciseModalHeader from "../CreateExerciseModal/CreateExerciseModalHeader";
import { SetList } from "../CreateExerciseModal/SetList";

type Props = {
  workoutId: string;
};

export function EditExerciseModal({ workoutId }: Props) {
